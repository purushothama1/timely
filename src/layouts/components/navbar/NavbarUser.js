...
import notifactionImage from "../../../assets/img/pages/Group 5.png"
import  firebase from '../../../firebase'


const NotificatinDropdown = props => {

  return(
    <DropdownMenu  style={{width:"30vw", marginLeft:"-23px"}}  right>
      <DropdownItem style={{width:"100%"}}> 
        <div>
          <p style={{textAlign:"center"}}>Notification</p>
          <hr/>
          <p style={{textAlign:"center"}}>
          <img src={notifactionImage} />
          
          </p>
        
          <p style={{textAlign:"center"}}>There are no notification at the moment!
          </p>
         <hr/>
...
{/* 
        ...
        <UncontrolledDropdown tag="li" className="dropdown-user nav-item">
          ...
          <NotificatinDropdown  {...this.props}/>
        </UncontrolledDropdown>
        
        {/* <p style={{display : "inline", marginTop:"10%", marginLeft:"-4%", paddingRight:"13px"}}>
          <Icon.Bell/>
        </p> */}
      </ul>
